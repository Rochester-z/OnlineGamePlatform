...
public class SecondPassBirdPanel extends JPanel implements MouseMotionListener, MouseListener {
    ...
    //墙体
    Image image2 = PictureUtil.getPictureBird("wall2.png").getImage();
    //小猪
...
//        g2.drawLine(shootx,shooty,122,449);
    ...
    public void paint(Graphics g){
        ...
        //绘制墙体
        g.drawImage(image2, 350, 100, 450,700, null);
...
//            g.drawImage(image1, 0, 420, 150, 120, null);
        ...
        //绘制小鸟子弹
        //每隔10ms移动一次小鸟子弹数组中的小鸟子弹,重绘一次
        if(flag2) {            //当释放鼠标时,每隔10ms,所有小鸟子弹移动一次位置,并画出来
    ...
    public void begin() throws InterruptedException {
        ...
        for(int i=0; i<5; i++){
            ...
            cuteBird.setx(180+100*i);
            cuteBird.sety(100+20*i);
            ListCuteBird.add(cuteBird);
        }
        for(int i=0; i<5; i++){
            CuteBird cuteBird = new CuteBird();
            cuteBird.setx(180+100*i);
            cuteBird.sety(340-20*i);
            ListCuteBird.add(cuteBird);
        }
