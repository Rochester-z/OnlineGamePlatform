...
public class FifthPassBirdUI extends Thread{
    //关卡选择界面
    StageUI stageUI;

    public static void main(String[] args) {
        FifthPassBirdUI ui = new FifthPassBirdUI();
        ui.start();
    }

//    public static void main(String[] args) {
//        FourthPassBirdUI ui = new FourthPassBirdUI();
//        ui.start();
//    }
    ...
    public void run() {
        ...
        FifthPassBirdPanel panel = new FifthPassBirdPanel();
        jf.add(panel);
        panel.jf = jf;  //将开始界面传入面板来操作开始界面
        panel.stageUI = stageUI;    //必须有
