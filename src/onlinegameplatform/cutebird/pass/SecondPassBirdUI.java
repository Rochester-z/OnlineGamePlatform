...
public class SecondPassBirdUI extends Thread{
    //关卡选择界面
    StageUI stageUI;

//    public static void main(String[] args) {
//        Pass.SecondPassBirdUI ui = new Pass.SecondPassBirdUI();
//        ui.start();
//    }
...
//        scoreUI.setVisible(false);
        ...
        SecondPassBirdPanel panel = new SecondPassBirdPanel();
        jf.add(panel);
