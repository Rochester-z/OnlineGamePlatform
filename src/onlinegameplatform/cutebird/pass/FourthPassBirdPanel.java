...
public class FourthPassBirdPanel extends JPanel implements MouseMotionListener, MouseListener {
    ...
    //墙体
    Image image2 = PictureUtil.getPictureBird("wall4.png").getImage();
    //小猪
...
//            g.drawImage(image1, 0, 420, 150, 120, null);
    ...
    public void begin() throws InterruptedException {
        ...
        for(int i=0; i<3; i++){
            ...
            cuteBird.setx(100+80*i);
            cuteBird.sety(200+100*i);
            ListCuteBird.add(cuteBird);
        }

        for(int i=0; i<3; i++){
            CuteBird cuteBird = new CuteBird();
            cuteBird.setx(330+80*i);
            cuteBird.sety(400-100*i);
            ListCuteBird.add(cuteBird);
        }

        for(int i=0; i<2; i++){
            CuteBird cuteBird = new CuteBird();
            cuteBird.setx(100+140*i);
            cuteBird.sety(130-100*i);
            ListCuteBird.add(cuteBird);
        }
